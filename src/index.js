...
app.put("/api/agents/:id", requireAuth, async (req, res) => {
  ...
  const schema = z.object({
    ...
    toolConfigs: z.record(z.string(), z.object({ name: z.string().max(80).optional(), description: z.string().max(800).optional(), transferTo: z.string().max(40).optional() })).optional(),
